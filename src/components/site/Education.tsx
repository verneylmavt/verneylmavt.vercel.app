        ...
        <ol className="flex flex-col gap-10">
          {site.education.map((edu, i) => (
            <li key={`${edu.institution}-${edu.start}`}>
              <div className="grid gap-y-4 md:grid-cols-12 md:gap-x-6">
                {/* Index */}
                ...
                <div className="md:col-span-5">
                  <div className="flex flex-col gap-2">
                    <KeyValue k="institution" v={edu.institution} />
                ...
                <div className="md:col-span-6">
                  {edu.description ? (
                    <p className="text-[0.9375rem] leading-[1.6] text-muted-soft">
                      <span className="text-muted-soft/70" aria-hidden="true">{"/* "}</span>
                      {edu.description}
                      <span className="text-muted-soft/70" aria-hidden="true">{" */"}</span>
                    </p>
                  ) : null}
